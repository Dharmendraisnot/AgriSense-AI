...
_INTENT_MAP = {
    "weather":  ["weather", "rain", "temperature", "forecast", "climate", "humidity", "monsoon", "wind"],
    "crop":     ["crop", "grow", "plant", "cultivate", "sow", "seed", "which crop", "season", "harvest"],
    "soil":     ["soil", "ph", "nitrogen", "phosphorus", "potassium", "fertility", "nutrient", "organic matter"],
    "pest":     ["pest", "disease", "insect", "fungus", "blight", "wilt", "rot", "symptom", "yellow", "leaves", "spots", "dying", "attack", "infected", "bug", "virus"],
    "market":   ["price", "mandi", "market", "rate", "sell", "cost", "rupee", "kgrate", "buy", "trade"],
    "rag":      ["yield", "improve", "advice", "guide", "how to", "what is", "best practice"],
}

# Priority used to break ties (higher wins)
_PRIORITY = {"pest": 6, "soil": 5, "weather": 4, "market": 3, "crop": 2, "rag": 1}
...
class CoordinatorAgent(BaseAgent):
    ...
    def _classify_intent(self, message: str) -> str:
        ...
        if max_score == 0:
            ...
            # Among all intents with the top score, pick the highest-priority one
            candidates = [k for k, v in scores.items() if v == max_score]
            best_intent = max(candidates, key=lambda k: _PRIORITY.get(k, 0))
