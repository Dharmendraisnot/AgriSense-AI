...
On Streamlit Cloud the .env file does not exist, so we detect that and skip it
to avoid pydantic-settings falling back to stale cached values.
"""
...
class Settings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        # Only read .env when the file actually exists (local dev).
        # On Streamlit Cloud the file is absent so os.environ is the sole source.
