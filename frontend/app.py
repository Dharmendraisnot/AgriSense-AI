...
# Both are inserted so that EITHER naming works.
...
# All subsequent imports use this variable instead of the hard-coded string.
_pkg = _here.name
...
# ── Import components using the runtime package name ─────────────────────────
