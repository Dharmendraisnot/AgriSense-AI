...
# Works whether Streamlit runs from the repo root or from inside frontend/.
_here = Path(__file__).resolve().parent        # .../frontend
_project_root = _here.parent                   # .../agrisense-ai (repo root)
